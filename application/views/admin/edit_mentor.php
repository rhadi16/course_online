        ...
        <div class="col-sm-12">
            <div class="card shadow">
                <div class="card-header py-3">
                    <h5 class="border-start border-4 border-warning m-0 ps-3"><b>Edit</b> Mentor</h5>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12">
                                <div class="row mb-3 align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control rounded-4" id="email" name="email" value="<?= $detail['email']; ?>">
