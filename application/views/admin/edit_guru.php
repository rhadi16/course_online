    ...
    <div class="row justify-content-center">
        <div class="col-md-6 col-sm-12">
            <div class="card shadow">
                <h5 class="card-header">Form Edit Guru</h5>
                <div class="card-body">
                    <form action="" method="post">
                        <input type="hidden" name="id_lama" value="<?= $detail['id_guru']; ?>">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <?php $i = 0;
                            foreach ($mapel as $m) : ?>
                                <?php $dmp = $this->Admin_model->detailMapelGuru($detail['id_guru'], $m['id']); ?>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="<?= $m['id']; ?>" id="mapel<?= $m['id']; ?>" name="mapel[]" <?= $retVal = ($dmp) ? "checked" : ''; ?>>
